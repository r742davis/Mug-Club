...
export const OPEN_PASSWORD_RESET = "OPEN_PASSWORD_RESET";
export const CLOSE_PASSWORD_RESET = "CLOSE_PASSWORD_RESET";
export const RETURN_SUCCESS_MESSAGE = "RETURN_SUCCESS_MESSAGE";
